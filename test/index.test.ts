 ...
 * under the License.
 */
import { SupersetPluginChartConfidenceBands } from '../src';
 ...
 */
describe('superset-plugin-chart-confidence-bands', () => {
  it('exists', () => {
    expect(SupersetPluginChartConfidenceBands).toBeDefined();
  });
});
